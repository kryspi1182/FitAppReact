...
import {
  ...
  resetTrainings,
} from "../../../store/User/UserTrainingsSlice";
...
const CustomTraining: React.FC<Props> = (props) => {
  ...
  const mapItemsToTrainingConditions = (items: AutocompleteItem[]) => {
    ...
    formik.setFieldValue(
      "trainingConditions",
      trainingConditions.filter((condition) =>
        ...
        <Row className={classes.row}>
          <Col xs="6">
            <FormControl className={classes.formControl}>
              ...
              >
                <MenuItem value={TrainingCategoryEnum.Circuit}>
                  Circuit
                </MenuItem>
                <MenuItem value={TrainingCategoryEnum.Fartlek}>
                  Fartlek
                </MenuItem>
                <MenuItem value={TrainingCategoryEnum.Flexibility}>
                  Flexibility
                </MenuItem>
                <MenuItem value={TrainingCategoryEnum.Continuous}>
                  Continuous
                </MenuItem>
                <MenuItem value={TrainingCategoryEnum.Interval}>
                  Interval
                </MenuItem>
                <MenuItem value={TrainingCategoryEnum.Plyometric}>
                  Plyometric
                </MenuItem>
          ...
          <Col xs="6">
            <FormControl className={classes.formControl}>
              ...
              >
                ...
                <MenuItem value={DifficultyEnum.Intermediate}>
                  Intermediate
                </MenuItem>
                <MenuItem value={DifficultyEnum.Advanced}>Advanced</MenuItem>
                <MenuItem value={DifficultyEnum.Professional}>
                  Professional
                </MenuItem>
              </Select>
            </FormControl>
