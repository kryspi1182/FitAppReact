...
import {
  selectUserMacros,
  fetchUserMacros,
} from "../../store/User/UserMacrosSlice";
import {
  selectAllMedicalConditions,
  fetchMedicalConditions,
} from "../../store/Diet/MedicalConditionsSlice";
          ...
          <Col className={classes.column} xs="6">
            <FormControl className={classes.formControl} variant="outlined">
              ...
              <Select
                ...
                className={classes.formInput}
              >
                <MenuItem value={WeightTargetEnum.LoseWeight}>
                  Lose weight
                </MenuItem>
                <MenuItem value={WeightTargetEnum.MaintainWeight}>
                  Maintain weight
                </MenuItem>
                <MenuItem value={WeightTargetEnum.GainWeight}>
                  Gain weight
                </MenuItem>
              </Select>
            </FormControl>
