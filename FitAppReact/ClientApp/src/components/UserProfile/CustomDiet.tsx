                        ...
                        <TextField
                            ...
                            onChange={(event) => {
                                if(!isNaN(parseInt(event.target.value)))
                                    formik.setFieldValue('calories', parseInt(event.target.value));
                            }}
                ...
                <Col className={classes.column}>
                    <FormControl className={classes.formControl}>
                        <TextField
                            ...
                            onChange={(event) => {
                                if(!isNaN(parseInt(event.target.value)))
                                    formik.setFieldValue('carbohydrates', parseInt(event.target.value));
                            }}
                ...
                <Col className={classes.column}>
                    <FormControl className={classes.formControl}>
                        <TextField
                            ...
                            onChange={(event) => {
                                if(!isNaN(parseInt(event.target.value)))
                                    formik.setFieldValue('protein', parseInt(event.target.value));
                            }}
